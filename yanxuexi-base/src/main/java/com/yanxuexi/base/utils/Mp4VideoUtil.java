package com.yanxuexi.base.utils;
...
// 不做视频转码后时间校验，因为转码后的视频可能比原视频多一秒，目前尚不清楚原因
...
//        }
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\Develop\\Java\\tool\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\Develop\\test\\fileUpload\\avi1.avi";
        //转换后mp4文件的名称
        String mp4_name = "translate_1.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Develop\\test\\fileUpload\\translate_1.mp4";
        //创建工具类对象
