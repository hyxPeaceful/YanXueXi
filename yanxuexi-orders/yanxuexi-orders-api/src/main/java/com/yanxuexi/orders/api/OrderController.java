package com.yanxuexi.orders.api;
...
import com.yanxuexi.orders.util.SecurityUtil;
...
public class OrderController {
    ...
    public void requestpay(String payNo, HttpServletResponse httpResponse) throws IOException {
        ...
        if (payRecord == null) {
            YanXueXiException.cast("请重新点击支付获取二维码");
        }
        //支付状态
        String status = payRecord.getStatus();
        if ("601002".equals(status)) {
            YanXueXiException.cast("订单已支付，请勿重复支付。");
        }
        //构造sdk的客户端对象
...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("http://25t5pj.natappfree.cc/orders/receivenotify");//在公共参数中设置回跳和通知地址
